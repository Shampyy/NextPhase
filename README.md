...
*   **Správa projektů** – Vytváření projektů, jejich rozřazování do kategorií a evidence spojených úkolů a deadlinů.
*   **Správa úkolů (To-do list)** – Centrální správa úkolů pro jednotlivé projekty i samostatných osobních/školních úkolů s možností nastavení termínu splnění.
*   **Tagovací systém** – Tvorba vlastních barevných štítků (tagů) pro lepší filtraci a organizaci jednotlivých úkolů.
*   **Dashboard** – Hlavní přehledová obrazovka zobrazující aktuální stav a úkoly na probíhající týden.
*   **Kalendář** – Vizuální zobrazení deadlinů a událostí s možností okamžitého přidávání nových.
*   **Notes (Rychlé poznámky)** – Prostor pro ukládání rychlých nápadů, poznámek nebo užitečných odkazů pro pozdější využití.
...
*   **Databáze:** MySQL
*   **Frontend:** HTML, CSS
*   **Vývojové prostředí:** Vyvíjeno s využitím PHPStorm
